...
var src = __webpack_require__(606);

// EXTERNAL MODULE: ./src/App.css
var App = __webpack_require__(607);

// EXTERNAL MODULE: ./node_modules/react-tabs/esm/index.js + 11 modules
var esm = __webpack_require__(238);

// EXTERNAL MODULE: ./node_modules/react-tabs/style/react-tabs.css
var react_tabs = __webpack_require__(609);
...
var animated = __webpack_require__(574);
...
var es6 = __webpack_require__(236);

// CONCATENATED MODULE: ./src/charts/recahrts.js
var RADIAN=Math.PI/180;var recahrts_pros=['Free','svg','Well customizable'];var recahrts_cons=['React only'];var recahrts_renderCustomizedLabel=function renderCustomizedLabel(_ref){var cx=_ref.cx,cy=_ref.cy,midAngle=_ref.midAngle,innerRadius=_ref.innerRadius,outerRadius=_ref.outerRadius,percent=_ref.percent,index=_ref.index;var radius=innerRadius+(outerRadius-innerRadius)*2;var x=cx+radius*Math.cos(-midAngle*RADIAN);var y=cy+radius*Math.sin(-midAngle*RADIAN);return/*#__PURE__*/react_default.a.createElement("text",{x:x,y:y,fill:"black",textAnchor:x>cx?'start':'end',dominantBaseline:"central"},DEFAULT_DATA[index].country);};var recahrts_Rechart=/*#__PURE__*/function(_PureComponent){Object(inherits["a" /* default */])(Rechart,_PureComponent);var _super=Object(createSuper["a" /* default */])(Rechart);function Rechart(){var _this;Object(classCallCheck["a" /* default */])(this,Rechart);for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}_this=_super.call.apply(_super,[this].concat(args));_this.data=DEFAULT_DATA;_this.colors=COLORS;_this.state={};_this.handleMouseEnter=function(value){_this.setState(Object(defineProperty["a" /* default */])({},value,true));};_this.handleMouseLeave=function(value){_this.setState(Object(defineProperty["a" /* default */])({},value,false));};_this.options={data:_this.data,dataKey:'litres',nameKey:'country',innerRadius:70,isAnimationActive:false,outerRadius:90,fill:'#82ca9d',label:recahrts_renderCustomizedLabel};return _this;}Object(createClass["a" /* default */])(Rechart,[{key:"render",value:function render(){var _this2=this;return/*#__PURE__*/react_default.a.createElement("div",{className:"chart-demo"},/*#__PURE__*/react_default.a.createElement("a",{href:"https://recharts.org/",target:"_blank",rel:"noopener noreferrer"},/*#__PURE__*/react_default.a.createElement("h3",null,"Recharts (14.5K\u2605)")),/*#__PURE__*/react_default.a.createElement(es6["d" /* PieChart */],{width:500,height:300},/*#__PURE__*/react_default.a.createElement(es6["b" /* Legend */],{onMouseEnter:function onMouseEnter(o){return _this2.handleMouseEnter(o.value);},onMouseLeave:function onMouseLeave(o){return _this2.handleMouseLeave(o.value);}}),/*#__PURE__*/react_default.a.createElement(es6["c" /* Pie */],this.options,this.data.map(function(_ref2,index){var country=_ref2.country;var opacity=_this2.state[country]?1:.5;var style=_this2.state[country]?{transform:'scale(1.01)'}:null;return/*#__PURE__*/react_default.a.createElement(es6["a" /* Cell */],{key:"cell-".concat(index),fill:_this2.colors[index],fillOpacity:opacity,style:style,onMouseEnter:function onMouseEnter(){return _this2.handleMouseEnter(country);},onMouseLeave:function onMouseLeave(){return _this2.handleMouseLeave(country);}});}))),/*#__PURE__*/react_default.a.createElement(pros_cons_ProsCons,{cons:recahrts_cons,pros:recahrts_pros}));}}]);return Rechart;}(react["PureComponent"]);
// EXTERNAL MODULE: ./node_modules/react-chartist/dist/index.js
var dist = __webpack_require__(377);
...
var nivo_pie_esm = __webpack_require__(573);
...
var highcharts = __webpack_require__(378);
...
var highcharts_react_min = __webpack_require__(572);
var highcharts_react_min_default = /*#__PURE__*/__webpack_require__.n(highcharts_react_min);

// CONCATENATED MODULE: ./src/charts/highcharts.js
var highcharts_pros=['Framework agnostic','SVG','Official react wrapper','Well customizable','Has interactive events'];var highcharts_cons=['Paid'];var highcharts_Highchart=function Highchart(){var options={colors:COLORS,chart:{type:'pie'},tooltip:{headerFormat:'<span style="font-size: 10px">Custom tooltip {point.key}</span><br/>'},plotOptions:{pie:{allowPointSelect:true,cursor:'pointer',dataLabels:{enabled:true},showInLegend:true}},series:[{innerSize:'80%',events:{mouseOver:function mouseOver(e){console.log(this);}},data:DEFAULT_DATA.map(function(_ref){var litres=_ref.litres,country=_ref.country;return[country,litres];})}]};return/*#__PURE__*/react_default.a.createElement("div",{className:"chart-demo"},/*#__PURE__*/react_default.a.createElement("a",{href:"https://www.highcharts.com/",target:"_blank",rel:"noopener noreferrer"},/*#__PURE__*/react_default.a.createElement("h3",null,"highcharts ($)")),/*#__PURE__*/react_default.a.createElement(highcharts_react_min_default.a,{highcharts:highcharts_default.a,options:options}),/*#__PURE__*/react_default.a.createElement(pros_cons_ProsCons,{cons:highcharts_cons,pros:highcharts_pros}));};
// CONCATENATED MODULE: ./src/utils/all-charts-demo.js
var all_charts_demo_AllChartsDemo=function AllChartsDemo(){var demos=[{name:'Highcharts',component:/*#__PURE__*/react_default.a.createElement(highcharts_Highchart,null)},{name:'Nivo',component:/*#__PURE__*/react_default.a.createElement(nivo_Nivo,null)},{name:'Chartist',component:/*#__PURE__*/react_default.a.createElement(chartist_Chartist,null)},{name:'Ecahrts',component:/*#__PURE__*/react_default.a.createElement(echarts_ECharts,null)},{name:'Apex',component:/*#__PURE__*/react_default.a.createElement(apex_ApexChart,null)},{name:'Anychart',component:/*#__PURE__*/react_default.a.createElement(anychart_Anychart,null)},{name:'Chartjs',component:/*#__PURE__*/react_default.a.createElement(chartjs_ChartJS,null)},{name:'Amcharts',component:/*#__PURE__*/react_default.a.createElement(amcharts,null)},{name:'Recharts',component:/*#__PURE__*/react_default.a.createElement(recahrts_Rechart,null)}];return/*#__PURE__*/react_default.a.createElement("div",null,/*#__PURE__*/react_default.a.createElement("h1",null,"Javascript chart libraries comparison"),/*#__PURE__*/react_default.a.createElement(esm["d" /* Tabs */],null,/*#__PURE__*/react_default.a.createElement(esm["b" /* TabList */],null,demos.map(function(_ref){var name=_ref.name;return/*#__PURE__*/react_default.a.createElement(esm["a" /* Tab */],{key:name},name);})),demos.map(function(_ref2,i){var component=_ref2.component;return/*#__PURE__*/react_default.a.createElement(esm["c" /* TabPanel */],{key:i},component);})));};
...
//# sourceMappingURL=main.00141dd7.chunk.js.map